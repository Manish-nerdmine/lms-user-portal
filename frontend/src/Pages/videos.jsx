          ...
          <div className="flex flex-col gap-2">
            {videos.map((vid, index) => (
              <button
                ...
                className={`flex justify-between items-center px-3 py-2 rounded-md border transition ${
                  activeItem && activeItem._id === vid._id
            ...
            {quizzes.map((quiz, index) => (
              <button
                ...
                className={`flex justify-between items-center px-3 py-2 rounded-md border transition ${
                  activeItem && activeItem._id === quiz._id
                    ? "bg-blue-600 text-white shadow"
                    : "bg-gray-50 hover:bg-gray-100"
                }`}
              >
            ...
            activeItem.type === "video" ? (
              ...
              <div className="bg-white rounded-lg shadow p-4">
                    ...
                    <div className="flex flex-col mt-1 gap-1">
                      {q.options.map((opt) => (
                        <button
                          ...
                          className={`px-3 py-1 rounded border text-left transition ${
                ...
                {!completedQuizzes.includes(activeItem._id) && (
                  <button
                    onClick={() => handleQuizComplete(activeItem._id)}
