      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white p-4 rounded-lg shadow flex flex-col gap-2">
          ...
          <h3 className="text-2xl font-bold">
            1{courses.length + overdueCourses.length + completedCourses.length}
          </h3>
        ...
        <div className="bg-white p-4 rounded-lg shadow flex flex-col gap-2">
          ...
          <p className="text-gray-500 text-xs">
            {" "}
            1{dueThisWeek.length} due this week
          </p>
        </div>
      ...
      <section className="mb-6">
                ...
                <div key={idx} className="bg-white p-4 rounded-lg shadow mb-3">
                  <div className="flex justify-between items-center">
                    <h4 className="font-medium">
                      {course.courseDetails.title} Phish farm
                    </h4>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    {course.courseDetails.description} phish farm
                  </p>
        ...
        {overdueCourses
          ...
          .map((course, idx) => (
            <div key={idx} className="bg-white p-4 rounded-lg shadow mb-3">
              <div className="flex justify-between items-center">
                <h4 className="font-medium">{course.courseDetails.title} phish farm</h4>
